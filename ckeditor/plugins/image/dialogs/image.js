  ...
  var v = function(d, l) {
    ...
    var m = /^\s*(\d+)((px)|\%)?\s*$/i, z = /(^\s*(\d+)((px)|\%)?\s*$)|^$/i, r = /^\d+px$/, A = function() {
      ...
      if ("true" == c.getCustomData("isReady")) {
        ...
        //d && d.setValue(g); 移除取得寬高
        // f && f.setValue(c);
		//alert('已選取圖片!! 該圖片大小 寬:'+g+'高:'+c+'\n 如需使用原圖大小請設定上述寬高');
		document.getElementById('ckeditor_jimage_mesg').innerHTML = '<span>已選取圖片!!<br> 該圖片大小 寬:'+g+'高:'+c+'\n 如需使用原圖大小請設定上述寬高<br><br>響應式設計(RWD)請將寬度設定100% 高度留空白</span>';
      }
      e(a);
    }, C = function(a, b) {
      function c(a, b) {
    ...
    return {title:d.lang.image["image" == l ? "title" : "titleButton"], minWidth:"moono-lisa" == (CKEDITOR.skinName || d.config.skin) ? 500 : 420, minHeight:360, onShow:function() {
      ...
      if (this.imageEditMode) {
        ...
        "image" == l && "input" == a && confirm(d.lang.image.button2Img) ? (this.imageElement = d.document.createElement("img"), this.imageElement.setAttribute("alt", ""), d.insertElement(this.imageElement)) : "image" != l && "img" == a && confirm(d.lang.image.img2Button) ? (this.imageElement = d.document.createElement("input"), this.imageElement.setAttributes({type:"image", alt:""}), d.insertElement(this.imageElement)) : (this.imageElement = this.cleanImageElement, delete this.cleanImageElement);
      } else {
    ...
    }, contents:[{id:"info", label:d.lang.image.infoTab, accessKey:"I", elements:[{type:"vbox", padding:0, children:[{type:"hbox", widths:["280px", "110px"], align:"right", className:"cke_dialog_image_url", children:[{id:"txtUrl", type:"text", label:d.lang.common.url, required:!0, onChange:function() {
    ...
    }, validate:CKEDITOR.dialog.validate.notEmpty(d.lang.image.urlMissing)}, {type:"button", id:"browse", style:"display:inline-block;margin-top:14px;", align:"center", label:d.lang.common.browseServer, hidden:!0, filebrowser:"info:txtUrl"}]}]}, {id:"txtAlt", type:"text", label:d.lang.image.alt, accessKey:"T", "default":"", onChange:function() {
      e(this.getDialog());
    }, setup:function(a, b) {
    ...
    }}, {type:"hbox", children:[{id:"basic", type:"vbox", children:[{type:"hbox", requiredContent:"img{width,height}", widths:["50%", "50%"], children:[{type:"vbox", padding:1, children:[{type:"text", width:"45px", id:"txtWidth", label:d.lang.common.width, onKeyUp:A, onChange:function() {
    ...
    }, html:'<div><a href="javascript:void(0)" tabindex="-1" title="' + d.lang.image.lockRatio + '" class="cke_btn_locked" id="' + t + '" role="checkbox"><span class="cke_icon"></span><span class="cke_label">' + d.lang.image.lockRatio + '</span></a><a href="javascript:void(0)" tabindex="-1" title="' + d.lang.image.resetSize + '" class="cke_btn_reset" id="' + y + '" role="button"><span class="cke_label">' + d.lang.image.resetSize + "</span></a></div>"}]}, {type:"vbox", padding:1, children:[{type:"text", 
    id:"txtBorder", requiredContent:"img{border-width}", width:"60px", label:d.lang.image.border, "default":"", onKeyUp:function() {
      e(this.getDialog());
    }, onChange:function() {
      k.call(this, "advanced:txtdlgGenStyle");
    ...
    "</td></tr></table></div></div><jimagetage id=\"ckeditor_jimage_mesg\"></jimagetage>"}]}]}]}, {id:"Link", requiredContent:"a[href]", label:d.lang.image.linkTab, padding:0, elements:[{id:"txtUrl", type:"text", label:d.lang.common.url, style:"width: 100%", "default":"", setup:function(a, b) {
      if (2 == a) {
