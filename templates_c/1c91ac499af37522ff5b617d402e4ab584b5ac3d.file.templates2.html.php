<?php /* Smarty version Smarty-3.1.18, created on 2014-09-22 12:43:45
         compiled from "D:\AppServ\www\jaln\templates\templates2.html" */ ?>
<?php /*%%SmartyHeaderCode:679253741ee1046ae0-49381307%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1c91ac499af37522ff5b617d402e4ab584b5ac3d' => 
    array (
      0 => 'D:\\AppServ\\www\\jaln\\templates\\templates2.html',
      1 => 1411360617,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '679253741ee1046ae0-49381307',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_53741ee10aa966_57513027',
  'variables' => 
  array (
    'data' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_53741ee10aa966_57513027')) {function content_53741ee10aa966_57513027($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['p']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['data']->value['mode_pic']) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
?>
                    <?php if ($_smarty_tpl->tpl_vars['data']->value['mode_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['class']=='sml') {?>
                 <!--原模組+背圖使用 <li><img src="upload/mode_pic/<?php echo $_smarty_tpl->tpl_vars['data']->value['mode_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['pic'];?>
" width="50" onclick="mode_canvas=this;"><br><?php echo $_smarty_tpl->tpl_vars['data']->value['mode_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['name'];?>
</li> -->
                 	<li><img src="upload/mode_pic/<?php echo $_smarty_tpl->tpl_vars['data']->value['mode_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['pic'];?>
" width="50" onclick="dep_change=1;img_url=this.src;mdclick('<?php echo $_smarty_tpl->tpl_vars['data']->value['mode_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['class'];?>
','<?php echo $_smarty_tpl->tpl_vars['data']->value['mode_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['class2'];?>
');"><br><?php echo $_smarty_tpl->tpl_vars['data']->value['mode_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['name'];?>
</li>
                    <?php }?>
                    <?php endfor; endif; ?>
               </ul>
      ...
      <div id="tabs-2">
          <div>
               <ul class="clearfix">
                    <?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']['p2'])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']['p2']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['name'] = 'p2';
$_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['data']->value['mode_background']) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
$_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['show'] = true;
$_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['max'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['loop'];
$_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['step'] = 1;
$_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['start'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['step'] > 0 ? 0 : $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['loop']-1;
if ($_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['show']) {
    $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['total'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['loop'];
    if ($_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['total'] == 0)
        $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['show'] = false;
} else
    $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['total'] = 0;
if ($_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['show']):

            for ($_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['index'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['start'], $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['iteration'] = 1;
                 $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['iteration'] <= $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['total'];
                 $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['index'] += $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['step'], $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['iteration']++):
$_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['rownum'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['iteration'];
$_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['index_prev'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['index'] - $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['step'];
$_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['index_next'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['index'] + $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['step'];
$_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['first']      = ($_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['iteration'] == 1);
$_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['last']       = ($_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['iteration'] == $_smarty_tpl->tpl_vars['smarty']->value['section']['p2']['total']);
?>
                 <li><img src="upload/mode_background/<?php echo $_smarty_tpl->tpl_vars['data']->value['mode_background'][$_smarty_tpl->getVariable('smarty')->value['section']['p2']['index']]['pic'];?>
" width="50" onclick="img_url=this.src;"><br><?php echo $_smarty_tpl->tpl_vars['data']->value['mode_background'][$_smarty_tpl->getVariable('smarty')->value['section']['p2']['index']]['name'];?>
</li>
                    <?php endfor; endif; ?>
               </ul>
           </div>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['p']['last']       = ($_smarty_tpl->tpl_vars['smarty']->value['section']['p']['iteration'] == $_smarty_tpl->tpl_vars['smarty']->value['section']['p']['total']);
?>
                <?php if ($_smarty_tpl->tpl_vars['data']->value['mode_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['class']=='mid') {?>
             <!--原模組+背圖使用 <li><img src="upload/mode_pic/<?php echo $_smarty_tpl->tpl_vars['data']->value['mode_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['pic'];?>
" width="50" onclick="mode_canvas=this;"><br><?php echo $_smarty_tpl->tpl_vars['data']->value['mode_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['name'];?>
</li> -->
                <li><img src="upload/mode_pic/<?php echo $_smarty_tpl->tpl_vars['data']->value['mode_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['pic'];?>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['p']['last']       = ($_smarty_tpl->tpl_vars['smarty']->value['section']['p']['iteration'] == $_smarty_tpl->tpl_vars['smarty']->value['section']['p']['total']);
?>
                <?php if ($_smarty_tpl->tpl_vars['data']->value['mode_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['class']=='big') {?>
             <!--原模組+背圖使用 <li><img src="upload/mode_pic/<?php echo $_smarty_tpl->tpl_vars['data']->value['mode_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['pic'];?>
" width="50" onclick="mode_canvas=this;"><br><?php echo $_smarty_tpl->tpl_vars['data']->value['mode_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['name'];?>
</li> -->
                <li><img src="upload/mode_pic/<?php echo $_smarty_tpl->tpl_vars['data']->value['mode_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['pic'];?>
...
');"><br><?php echo $_smarty_tpl->tpl_vars['data']->value['mode_pic'][$_smarty_tpl->getVariable('smarty')->value['section']['p']['index']]['name'];?>
   ...
   <!--  頭部 -->
   <div class="head"> <span class="top-btn"><a href="javascript:if (confirm('是否進行重新設計?')) window.location.reload();">設計圖</a></span> 
   <span class="top-btn"><img src="images/br_next_icon&amp;32.png" width="32" height="35" /></span>
   <span class="top-btn"><a href="javascript:alert('使用chrome瀏覽器,出現網頁無回應畫面,請點選”等一下”按鈕繼續等候,請勿中止網頁，產生說明書會因為上傳說明檔額花費不少時間請耐心等候!!');send_detail=true;abk(document.getElementById('msg').value);">列印</a></span>
   <span class="top-btn"><a href="javascript:alert('使用chrome瀏覽器,出現網頁無回應畫面,請點選”等一下”按鈕繼續等候,請勿中止網頁，產生說明書會因為上傳說明檔額花費不少時間請耐心等候!!');send_detail='download';abk(document.getElementById('msg').value);">下載</a></span>
   <span class="top-btn"><img src="images/br_next_icon&amp;32.png" width="32" height="35" /></span>
   <span class="top-btn"><a href="javascript:ordersend();">訂購</a></span> <!--<span class="top-btn"><a href="#"><img src="images/round_icon&amp;48.png" /></a></span>--> <img src="images/logo.jpg" width="122" height="59" / class="logo" /> </div>
   <script>
   function frame_show(value){
	   if(value=='download'){
			$('#output_pdf_download')[0].click();
	   }else{
		   $('#output_pdf')[0].click();
	   }
   }
...
<div class="main">
    ...
    <center>
      ...
      <!--  上傳圖片  -->
        ...
        底板方向
        <select id="change_wh" onfocus="img_opselect=1">
        ...
        <canvas id="litle" style="display:none;" alt="先縮圖使用canvas">不支援Canvas。</canvas>
        </div>
        <div class="pic-info">
         <!--檔案資訊顯示位置-->
   ...
   <div class="foot">版權所有 © 2014 頡霖 RESERVED.</div>
    ...
    <a id="output_pdf_download" href="tcpdf/output.php?download=1" target="_blank"></a>
</div>
</body>
<script>
...
function abk(msg_data,act){
    ...
    var loadHandler = function(e){
		...
		//--先做一個等比縮圖
		lit_canvas = document.getElementById('litle');
		lit_canvas.width = dep_x*pk_w;
		lit_canvas.height = dep_y*pk_h;
		temp_lit_img = lit_canvas.getContext('2d');
		//----------------
		/*			
		if (img_select_set==0){
		...
		*/
		if (img_select_set==0){
	        //使用自動放大隊應大小->context.drawImage(img, 0, 0, img.width, img.height, 0, 0, canvas.width, canvas.height);
				...
				var test_ep_w = 0;
				var test_ep_h = 0;
				if (canvas.width<=img.width) {sp_w = img.width; test_ep_w = img.width/canvas.width; } else {test_ep_w = canvas.width/img.width}
				if (canvas.height<=img.height) {sp_h = img.height; test_ep_h = img.height/canvas.height;} else {test_ep_h = canvas.height/img.height}
				kam=1;
				if (test_ep_w!=0 || test_ep_h!=0){
					if (test_ep_w>test_ep_h){
						sp_w = img.width*test_ep_w;
				...
				var lit_select_w = img.width- Math.ceil(Math.ceil(sp_w/2-canvas.width/2)/kam)*2;
				var lit_select_h = img.height-Math.ceil(Math.ceil(sp_h/2-canvas.height/2)/kam)*2;
				temp_lit_img.drawImage(img, Math.ceil(Math.ceil(sp_w/2-canvas.width/2)/kam), Math.ceil(Math.ceil(sp_h/2-canvas.height/2)/kam), lit_select_w, lit_select_h, 0, 0, lit_canvas.width, lit_canvas.height);
				wri(msg_data,wrod_size);
				temp_img = new Image();
				temp_img.src = lit_canvas.toDataURL();
				context.drawImage(temp_img, 0, 0, temp_img.width, temp_img.height, 0, 0, canvas.width, canvas.height);

		}else{
				/*等比例拖曳區開置中顯示*/
				var test_ep_w = 0;
				var test_ep_h = 0;
				if (canvas.width<=img_select_w) {sp_w = img_select_w; test_ep_w = img_select_w/canvas.width; } else {test_ep_w = canvas.width/img_select_w}
				if (canvas.height<=img_select_h) {sp_h = img_select_h; test_ep_h = img_select_h/canvas.height;} else {test_ep_h = canvas.height/img_select_h}
				kam=1;
				if (test_ep_w!=0 || test_ep_h!=0){
					if (test_ep_w>test_ep_h){
						sp_w = img_select_w*test_ep_w;
						sp_h = img_select_h*test_ep_w;
						kam = test_ep_w;
					}else{
						sp_w = img_select_w*test_ep_h;
						sp_h = img_select_h*test_ep_h;
						kam = test_ep_h;
					}
				}
				temp_lit_img.drawImage(img, img_select_x1+Math.ceil(Math.ceil(sp_w/2-canvas.width/2)/kam), img_select_y1+Math.ceil(Math.ceil(sp_h/2-canvas.height/2)/kam), img_select_w-Math.ceil(Math.ceil(sp_w/2-canvas.width/2)/kam)*2, img_select_h-Math.ceil(Math.ceil(sp_h/2-canvas.height/2)/kam)*2, 0, 0, lit_canvas.width, lit_canvas.height);
				//temp_lit_img.drawImage(img, img_select_x1, img_select_y1, img_select_w, img_select_h, 0, 0, lit_canvas.width, lit_canvas.height);
				wri(msg_data,wrod_size);
				temp_img = new Image();
				temp_img.src = lit_canvas.toDataURL();
				
				context.drawImage(img, 0, 0, temp_img.width, temp_img.height, 0, 0, canvas.width, canvas.height);
		}
        ...
        var imageData = temp_lit_img.getImageData(0, 0, lit_canvas.width, lit_canvas.height); 
        pixels = imageData.data; //擷取影像像素資料

        context.clearRect(0, 0, canvas.width, canvas.height); 
        
		//---設定放大縮小功能 預設值大小
		slider_default_w = canvas.width;
		slider_default_h = canvas.height;
		
		//--利用長寬計算切割數
         numTileRows = Math.ceil(imageData.height/1); 
         numTileCols = Math.ceil(imageData.width/1); 
		...
		kps[r] = new Array();
                for (var c = 0; c < numTileCols; c++) { 
                    ...
                    context.fillRect(x*tileWidth-(tileWidth/2), y*tileWidth-(tileHeight/2), tileWidth, tileHeight); 
                }; 
        };
		//--繪圖完後處理
		draw_after();
	   ...
	   //--判斷是否有上傳說明圖的參數 有的話為啟用PDF
		$("#dialog-modal").dialog( "close" );
		if (send_detail==true){
			send_detail = false;
			frame_show(send_detail);
		}
    };
    init();
}
...
function wri(msg,word_s){
		...
		var elem = canvas_obj;
		var elem = document.getElementById('litle');
...
function color_change(red,green,blue){
	...
	for (ee in color_array_r){
		temp[ee] = Math.abs(color_array_r[ee]-red)*1.625+Math.abs(color_array_g[ee]-green)*1.625+Math.abs(color_array_b[ee]-blue)*1.625;//--取得rgb 個數值誤差
		//--光彩誤差修正
...
function total_pick(){
	...
	for (k1 in kps){
		for (k2 in kps[k1]){
			...
			//判斷是否存在陣列中
			for (ee in id_pick[pick_index]){
					if (id_pick[pick_index][ee]==kps[k1][k2][0]) {count_pick[pick_index][ee]++;have_add = 1;break;}
			}
	...
	for (tp in id_pick){
	$.ajax( {
		url: "ajax.php?color_store="+(tp*1+1),
		data: {id_pick:JSON.stringify(id_pick[tp]),count_pick:JSON.stringify(count_pick[tp])},
		type:"POST",
		dataType:'json',
		async: false,
		success: function(msg){
	...
	$.ajax( {
		...
		success: function(msg){
			...
			for (k1 in draw_pick){
				for (k2 in draw_pick[k1]){
					for (aa in _2return){
						//---判斷一相同者替換員陣列
						if (_2return[aa]["sort_id"]==draw_pick[k1][k2] && typeof(_2return[aa]["sort_id"])!="undefined"){
							draw_pick[k1][k2] = _2return[aa]["change"]+'';
						}
					}
				}
			}
...
/*
			for (aa in id_pick){
				for (bb in id_pick[aa]){
					for (cc in _2return){
						if (_2return[cc]["sort_id"]==id_pick[aa][bb] && typeof(_2return[cc]["sort_id"])!="undefined"){
							id_pick[aa].splice(bb,1);
							count_pick[aa].splice(bb,1);
							all_pick[aa].splice(bb,1)
						}
					}
				}
			}
...
function c_r_v(){
	...
	/* 預設上傳時， 先判斷圖片為寬還是為高 依此做自動調整*/
	if (img_opselect==0 && img_select_set==0 && $('.original-pic img').width()<$('.original-pic img').height()){
		$('#change_wh').val('0');
	}else if (img_opselect==0 && img_select_set==0){
		$('#change_wh').val('1');
	}
...
function total_pick_send(id_pick,all_pick,count_pick,draw_pick){
	$.ajax( {
		url: "ajax.php",
		data: {total_pick:{"id_pick":JSON.stringify(id_pick)}},
		type:"POST",
		dataType:'text',
		async: false,
		success: function(msg){
	...
	$.ajax( {
		url: "ajax.php",
		data: {total_pick:{"count_pick":JSON.stringify(count_pick)}},
		type:"POST",
		dataType:'text',
		async: false,
		success: function(msg){
...
function mouse_set(obj){
	if (typeof(img_url) =='undefined' || img_url==null || img_url=='') return;
	m_act = obj;
	...
	//另外計算 比照小圖實際位置
	mouse_set_y = Math.ceil(mouse_set_y/$(canvas_obj).height()*$(document.getElementById('litle')).height());
	mouse_set_x = Math.ceil(mouse_set_x/$(canvas_obj).width()*$(document.getElementById('litle')).width());
	abk(document.getElementById('msg').value);
}
</script>
