<?php /* Smarty version Smarty-3.1.18, created on 2014-07-16 14:40:34
         compiled from "5a9b62884b7c1e73132ecd32e301ff42c1ac3387" */ ?>
<?php /*%%SmartyHeaderCode:222553c61e62505e35-05326405%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5a9b62884b7c1e73132ecd32e301ff42c1ac3387' => 
    array (
      0 => '5a9b62884b7c1e73132ecd32e301ff42c1ac3387',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '222553c61e62505e35-05326405',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_53c61e626a7643_52307023',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53c61e626a7643_52307023')) {function content_53c61e626a7643_52307023($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<script>
  $(function() {
	...
	<div id="win_corp_pic" class="corp-pic"><!--  裁切視窗 -->
       ...
       <span class="btn-style02"><a href="javascript:lef_button_click(null);">確 認</a></span>
...
<div class="main">
    ...
    <center>
           ...
           <div><input id="draw_line_status" name="" type="checkbox" value="" onclick="check_plates()"/> Show Plates</div>
           <script>
      ...
      <!--  上傳圖片  -->
        ...
        <span class="zoom-size"><span class="btn-style02"><a href="javascript:abk(document.getElementById('msg').value);">執行</a></span></span></div>
         ...
         <div class="text-size">
        文字工具
          <input type="text" id="msg" value=""> 大小<input type="text" size="2" id="word_size" value="100">px  色彩<input type="text" id="word_color">
          <script>
   ...
   <!--  底部 -->
   <div class="foot">版權所有 © 2013 桔霖 RESERVED.</div>
