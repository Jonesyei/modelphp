<?php /* Smarty version Smarty-3.1.18, created on 2014-08-27 17:29:09
         compiled from "D:\AppServ\www\jaln\serback\templates\products2.html" */ ?>
<?php /*%%SmartyHeaderCode:10439537c1344915ca5-25447638%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a837f4ebe241b4e05977d5b916cf7acce0c9fd29' => 
    array (
      0 => 'D:\\AppServ\\www\\jaln\\serback\\templates\\products2.html',
      1 => 1409131701,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10439537c1344915ca5-25447638',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_537c13451554d3_77411295',
  'variables' => 
  array (
    'admin_info' => 0,
    'close' => 0,
...
<?php if ($_valid && !is_callable('content_537c13451554d3_77411295')) {function content_537c13451554d3_77411295($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['admin_info']->value['view']=='list') {?>
<script>
...
" />
	...
	function addtolist(){
		...
		$('#size_td').append('<div class="zlist">規格: <input type="text" name="size[]" value="'+$('#size_add_box').val()+'"> 顏色:<input type="text" id="c'+temp_time+'" name="color[]" value=""> 現貨:<input type="text" name="stock[]" value="1" onkeyup="this.value=this.value.replace(/\D/g,\'\');"> 貨號:<input type="text" name="stock_no[]" value=""> <input type="button" value=" 刪除 " onclick="$(this).parent().remove();"></div>');
