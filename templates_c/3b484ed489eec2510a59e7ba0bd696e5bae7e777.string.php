<?php /* Smarty version Smarty-3.1.18, created on 2014-09-04 10:14:14
         compiled from "3b484ed489eec2510a59e7ba0bd696e5bae7e777" */ ?>
<?php /*%%SmartyHeaderCode:51475407caf68fc671-76501317%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3b484ed489eec2510a59e7ba0bd696e5bae7e777' => 
    array (
      0 => '3b484ed489eec2510a59e7ba0bd696e5bae7e777',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '51475407caf68fc671-76501317',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5407caf6a87115_31904729',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5407caf6a87115_31904729')) {function content_5407caf6a87115_31904729($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
?>
      ...
      <h3>購買者</h3>
      <div class="forms-style01"><!-- 表單 -->
        <ul>
          <li class="clearfix"><span class="options-th">購買人 :</span><span class="options-td">
            <input name="input" type="text" class="input-style01" />
          </span></li>
          <li class="clearfix"><span class="options-th">性　　別 :</span> <span class="options-td">
            <input type="radio" name="radio" id="radio" value="radio" />
            先生
            <input type="radio" name="radio" id="radio" value="radio" />
            小姐</span> </li>
          <li class="clearfix"><span class="options-th">聯絡電話 :</span><span class="options-td">
            <input name="input" type="text" class="input-style01" />
          </span></li>
          <li class="clearfix"><span class="options-th">電子信箱 :</span><span class="options-td">
            <input name="input" type="text" class="input-style01" />
          </span></li>
          <li class="clearfix"><span class="options-th">居住地址 :</span> <span class="options-td">
      ...
      <div class="forms-style01"> <!-- 表單 -->
        <ul>
          <li class="clearfix"><span class="options-th">收件人 :</span><span class="options-td">
            <input name="input" type="text" class="input-style01" />
          </span></li>
          <li class="clearfix"><span class="options-th">性　　別 :</span> <span class="options-td">
            <input type="radio" name="radio" id="radio" value="radio" />
          ...
          <li class="clearfix"><span class="options-th">送貨地址 :</span> <span class="options-td">
            <select name="select" id="select">
              <option>---請選擇城市---</option>
            </select>
            <input name="input" type="text" class="input-style01" />
        ...
        <div class="btn-bottom">
          <a href="shopping-car.html"><input name="" type="button" class="input-btn01" value="回上一步" /></a>
             <a href="message.html"><input name="" type="button" class="input-btn02" value="我要結帳" /></a>
        </div>
      </div>
   </div>
   <!-- InstanceEndEditable -->   
