<?php /* Smarty version Smarty-3.1.18, created on 2014-04-30 09:38:29
         compiled from "0446f6d1d89ba7a3db89782b4ea33dbeca6624d7" */ ?>
<?php /*%%SmartyHeaderCode:2468553605415b1ade0-44648402%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0446f6d1d89ba7a3db89782b4ea33dbeca6624d7' => 
    array (
      0 => '0446f6d1d89ba7a3db89782b4ea33dbeca6624d7',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '2468553605415b1ade0-44648402',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53605415bc10e0_69491980',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53605415bc10e0_69491980')) {function content_53605415bc10e0_69491980($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div class="wrapper">
<img src="images/title-service.png" width="1000" height="124" border="0">
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['about']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['data']->value['about'][2]) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
?>
        <li><a href="index2.php?ban=8&bid=<?php echo $_smarty_tpl->tpl_vars['data']->value['about'][2][$_smarty_tpl->getVariable('smarty')->value['section']['about']['index']]['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['data']->value['about'][2][$_smarty_tpl->getVariable('smarty')->value['section']['about']['index']]['name'];?>
</a></li>
        <?php endfor; endif; ?>
      </ul>
    </div>
