<?php /* Smarty version Smarty-3.1.18, created on 2014-08-18 12:25:01
         compiled from "D:\AppServ\www\jaln\serback\templates\preferential.html" */ ?>
<?php /*%%SmartyHeaderCode:3153253982eb0e9ed53-32591207%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1758b792ae9216d83b69abc18610e619da82a7d6' => 
    array (
      0 => 'D:\\AppServ\\www\\jaln\\serback\\templates\\preferential.html',
      1 => 1408099909,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3153253982eb0e9ed53-32591207',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_53982eb152ad84_49664639',
  'variables' => 
  array (
    'admin_info' => 0,
    'close' => 0,
...
<?php if ($_valid && !is_callable('content_53982eb152ad84_49664639')) {function content_53982eb152ad84_49664639($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['admin_info']->value['view']=='list') {?>
<script>
...
<div id="content_bg">
  ...
  <div class="title"><span><?php echo $_smarty_tpl->tpl_vars['admin_info']->value['title'];?>
    ...
    <ul>
    <li class="save"><a  onClick="javescript:$('#csv').submit();">匯出</a></li>
...
<?php echo $_smarty_tpl->tpl_vars['data']->value['list'][$_smarty_tpl->getVariable('smarty')->value['section']['idex']['index']]['oid_html'];?>
      ...
      <td><?php echo $_smarty_tpl->tpl_vars['data']->value['list'][$_smarty_tpl->getVariable('smarty')->value['section']['idex']['index']]['paymode_statushtml'];?>
</td>
...
?>
        <tr>
	        <td><?php echo $_smarty_tpl->tpl_vars['data']->value['carlist'][$_smarty_tpl->getVariable('smarty')->value['section']['cl']['index']]['id'];?>
             ...
             <td align="center" width="20%"><img src="../upload/products/<?php echo $_smarty_tpl->tpl_vars['data']->value['carlist'][$_smarty_tpl->getVariable('smarty')->value['section']['cl']['index']]['pic'];?>
" height="80"/></td>
...
<br><?php echo $_smarty_tpl->tpl_vars['data']->value['one']['recive_address'];?>
   ...
   <tr >
      <td align="right" >經銷商資訊：</td>
      <td >
      		<?php echo $_smarty_tpl->tpl_vars['data']->value['one']['company'];?>
