<?php /* Smarty version Smarty-3.1.18, created on 2014-09-03 18:16:34
         compiled from "d6e3e531b6cc4b9afb315496f95e1b0875a48fab" */ ?>
<?php /*%%SmartyHeaderCode:30405406ea826e4142-51397481%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd6e3e531b6cc4b9afb315496f95e1b0875a48fab' => 
    array (
      0 => 'd6e3e531b6cc4b9afb315496f95e1b0875a48fab',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '30405406ea826e4142-51397481',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5406ea827c2322_32405120',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5406ea827c2322_32405120')) {function content_5406ea827c2322_32405120($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div>
  ...
  <div class="header"><!-- 頭部 -->
      ...
      <div class="top-tool">
        ...
        <a href="index2.php?ban=17">購物車</a>
      </div>
  </div>
      ...
      <div class="shopping-car"><!-- 購物清單 -->
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td class="pro-name">產品名稱-規格</td>
            <td class="price">NT 90</td>
            <td class="numb">1</td>
            <td class="count">NT 90</td>
            <td class="count"><img src="images/btn-detel.png" width="24" height="24"></td>
          </tr>
          <tr>
            <td><img src="images/photos.jpg" width="200" height="200" class="pro-photo"></td>
            <td class="pro-name">產品名稱-規格</td>
            <td class="price">NT 90</td>
            <td class="numb">2</td>
            <td class="count">NT 180</td>
            <td class="count"><img src="images/btn-detel.png" width="24" height="24"></td>
          </tr>
        </tbody></table>
        <div class="count-portal">
          <div class="portal">總計 : <span class="count-price">NT 360</span></div>
             <div class="freight">運費 : <span class="count-price">NT 90 </span></div>
        </div>
        
        
        <div class="btn-bottom">
             <a href="index.html"><input name="" type="button" class="input-btn01" value="繼續購物"></a>
             <a href="check-out.html"><input name="" type="button" class="input-btn02" value="我要結帳"></a>
        </div>
